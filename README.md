...
> **24.09.2026 — методичка вычитана и исправлена.** Что найдено и что поправлено — в [fixes/graphql.md](https://github.com/meeymirita/submodule-group-lab/blob/main/fixes/graphql.md) сборного репозитория.
